...
```{r}
power_results_table$sample_size <- percentages_to_sample * n_obs
...
Note that the sample size will actually need to be half of what appears in the chart to reach the given power, since we have each subject participating in control and treatment. This was an estimate with a pretty conservative treatment effect. 
