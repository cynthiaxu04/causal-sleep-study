...
# Scenario 1 - Measurement: Sleep Score, ATE: 5

For this scenario we assume:

-   The average non-intervention sleep score is 75 (for scenarios 1 & 2). This is based on a small trial run of our experiment conducted with ourselves.
-   True ATE = 5. This is also based on the trial run we conducted.
...
# Scenario 2 - Measurement: Sleep Score, ATE: 3
...
# Scenario 3 - Measurement: Deep & REM sleep, ATE: 0.15 & 0.26, respectively
...
All of these values are based on a study conducted that compared consumer sleep-tracking devices to laboratory standards \textit{Chinoy, E, et al.}.
...
ate_rem
```
Unfortunately, we have extremely low statistical power if using percentage of REM or deep sleep phases as our main readout metric. It is unlikely we can feasibly go this route.
...
```{r echo=FALSE, include=TRUE}
#list of data.tables
data_tables <- list(ate_5, ate_3, ate_rem)
